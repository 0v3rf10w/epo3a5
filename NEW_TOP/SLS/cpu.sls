...
extern network pc_counter (terminal pc_in_7_0_7, pc_in_7_0_6, pc_in_7_0_5, 
                                    ...
                                    pc_rst, pc_en, pc_out_7_0_7, pc_out_7_0_6, 
...
network cpu (terminal cpu_rst, cpu_en, cpu_in_7_0_7, cpu_in_7_0_6, 
                      ...
                      cpu_out_7_0_0, vss, vdd)
{
   ...
   {lbl_decoder} decoder (cpu_instr_11_0_11, cpu_instr_11_0_10, 
                          ...
                          cpu_dec_pc_inc, cpu_dec_pc_ld, cpu_dec_ibufoe, 
   ...
   {lbl_cpu_ibuf} buf_arg (cpu_dec_o_7_port, cpu_dec_o_6_port, 
                           ...
                           cpu_bus_7_port, cpu_bus_6_port, cpu_bus_5_port, 
                           cpu_bus_4_port, cpu_bus_3_port, cpu_bus_2_port, 
                           cpu_bus_1_port, cpu_bus_0_port, vss, vdd);
   {lbl_cpu_pc} pc_counter (cpu_bus_7_port, cpu_bus_6_port, cpu_bus_5_port, 
                            cpu_bus_4_port, cpu_bus_3_port, cpu_bus_2_port, 
                            cpu_bus_1_port, cpu_bus_0_port, cpu_dec_pc_inc, 
                            cpu_dec_pc_ld, cpu_rst, cpu_en, cpu_pc_7_0_7, 
                            cpu_pc_7_0_6, cpu_pc_7_0_5, cpu_pc_7_0_4, 
                            cpu_pc_7_0_3, cpu_pc_7_0_2, cpu_pc_7_0_1, 
                            cpu_pc_7_0_0, vss, vdd);
   {lbl_cpu_alu} alu (cpu_bus_7_port, cpu_bus_6_port, cpu_bus_5_port, 
                      cpu_bus_4_port, cpu_bus_3_port, cpu_bus_2_port, 
                      cpu_bus_1_port, cpu_bus_0_port, cpu_areg_out_7_port, 
                      cpu_areg_out_6_port, cpu_areg_out_5_port, 
                      cpu_areg_out_4_port, cpu_areg_out_3_port, 
                      cpu_areg_out_2_port, cpu_areg_out_1_port, 
                      cpu_areg_out_0_port, cpu_alu_op_2_port, 
                      cpu_alu_op_1_port, cpu_alu_op_0_port, cpu_en, cpu_alu_c, 
                      cpu_alu_z, cpu_alu_out_7_port, cpu_alu_out_6_port, 
                      cpu_alu_out_5_port, cpu_alu_out_4_port, 
                      cpu_alu_out_3_port, cpu_alu_out_2_port, 
                      cpu_alu_out_1_port, cpu_alu_out_0_port, vss, vdd);
   {lbl_cpu_reg_A} reg_a (cpu_alu_out_7_port, cpu_alu_out_6_port, 
                          cpu_alu_out_5_port, cpu_alu_out_4_port, 
                          cpu_alu_out_3_port, cpu_alu_out_2_port, 
                          cpu_alu_out_1_port, cpu_alu_out_0_port, cpu_en, 
   ...
   {lbl_cpu_buf_A} buf_a (cpu_areg_out_7_port, cpu_areg_out_6_port, 
                          ...
                          cpu_bus_4_port, cpu_bus_3_port, cpu_bus_2_port, 
                          cpu_bus_1_port, cpu_bus_0_port, vss, vdd);
   {lbl_bregs} reg_cluster (n7, n12, n6, n11, n5, n10, n9, n8, cpu_en, cpu_rst, 
                            n2, cpu_dec_bregld_3_port, cpu_dec_bregld_2_port, 
                            cpu_dec_bregld_1_port, cpu_dec_bregld_0_port, n1, 
                            cpu_dec_bbufoe_3_port, cpu_dec_bbufoe_2_port, 
                            cpu_dec_bbufoe_1_port, cpu_dec_bbufoe_0_port, 
                            cpu_in_7_0_7, cpu_in_7_0_6, cpu_in_7_0_5, 
                            cpu_in_7_0_4, cpu_in_7_0_3, cpu_in_7_0_2, 
                            cpu_in_7_0_1, cpu_in_7_0_0, cpu_bus_7_port, 
                            cpu_bus_6_port, cpu_bus_5_port, cpu_bus_4_port, 
                            cpu_bus_3_port, cpu_bus_2_port, cpu_bus_1_port, 
                            cpu_bus_0_port, cpu_out_7_0_7, cpu_out_7_0_6, 
   ...
   {U5} buf40 (cpu_bus_3_port, n5, vss, vdd);
   {U6} buf40 (cpu_bus_5_port, n6, vss, vdd);
   {U7} buf40 (cpu_bus_7_port, n7, vss, vdd);
   {U8} buf40 (cpu_bus_0_port, n8, vss, vdd);
   {U9} buf40 (cpu_bus_1_port, n9, vss, vdd);
   {U10} buf40 (cpu_bus_2_port, n10, vss, vdd);
   {U11} buf40 (cpu_bus_4_port, n11, vss, vdd);
   {U12} buf40 (cpu_bus_6_port, n12, vss, vdd);
}
