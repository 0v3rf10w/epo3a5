...
\section{VGA}
\lstinputlisting[language=VHDL]{VHDL/counter-behaviour.vhd}
\lstinputlisting[language=VHDL]{VHDL/deler-behaviour.vhd}
\lstinputlisting[language=VHDL]{VHDL/hsync-behaviour.vhd}
\lstinputlisting[language=VHDL]{VHDL/rgb-behaviour.vhd}
\lstinputlisting[language=VHDL]{VHDL/scount-behaviour.vhd}
\lstinputlisting[language=VHDL]{VHDL/ssync-behaviour.vhd}
\lstinputlisting[language=VHDL]{VHDL/verticaltel.vhd}
\lstinputlisting[language=VHDL]{VHDL/vga-behaviour.vhd}
\lstinputlisting[language=VHDL]{VHDL/vidcounter-behaviour.vhd}
\lstinputlisting[language=VHDL]{VHDL/vsync-behaviour.vhd}
