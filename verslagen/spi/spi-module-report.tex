...
\subsection{Counter}
Counter is a simple counter that goes up by one for every rising edge of the clock. It is a 4-bit counter which has a clock and reset as inputs and a output count as output. The VHDL description can be found in \ref{counter-vhdl}
