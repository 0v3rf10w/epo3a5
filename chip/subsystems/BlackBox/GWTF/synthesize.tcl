#*********************************************************
#  synthesize script for cell: stream                     *
#*********************************************************
...
set link_library [list "*" "./ADB/tbuf.ddc" "/data/public/common/software/opprog/synth_libs/g_digilib5_99.db" "/data/public/common/software/opprog/synth_libs/g_analib8_00.db" "/data/public/common/software/opprog/synth_libs/buffers.db"]
...
read_file -format vhdl -work MY_LIB {VHDL/stream.vhd VHDL/stream-behaviour.vhd}
set_dont_touch {tbuf}
...
report_area
report_fsm
write_file -f ddc stream -output ./ADB/stream.ddc
write_file -f vhdl stream -output ./VHDL/stream_SYNTH.vhd
quit
