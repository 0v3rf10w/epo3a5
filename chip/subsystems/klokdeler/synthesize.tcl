#*********************************************************
#  synthesize script for cell: dff                        *
#*********************************************************
...
define_design_lib MY_LIB -path /tmp/ndewinter//home/ndewinter/klokdeler/syn_work
define_design_lib CELLSLIB -path /data/public/common/software/opprog/synth_libs/CellsLib
read_file -format vhdl -work MY_LIB {/tmp/ndewinter//home/ndewinter/klokdeler/VHDL/dff2.vhd /tmp/ndewinter//home/ndewinter/klokdeler/VHDL/dff-behavioural.vhd}
...
report_area
report_fsm
write_file -f ddc dff -output /tmp/ndewinter//home/ndewinter/klokdeler/ADB/dff.ddc
write_file -f vhdl dff -output /tmp/ndewinter//home/ndewinter/klokdeler/VHDL/dff_SYNTH.vhd
quit
