#*********************************************************
#  synthesize script for cell: cpu_tb                     *
#*********************************************************
...
set designer "bmeekes"
set target_library  {"/data/public/common/software/opprog/synth_libs/g_digilib5_99.db"}
set link_library [list "*" "./ADB/cpu.ddc" "/data/public/common/software/opprog/synth_libs/g_digilib5_99.db" "/data/public/common/software/opprog/synth_libs/g_analib8_00.db" "/data/public/common/software/opprog/synth_libs/buffers.db"]
...
read_file -format vhdl -work MY_LIB {VHDL/cpu_tb.vhd }
set_dont_touch {cpu}
...
report_area
report_fsm
write_file -f ddc cpu_tb -output ./ADB/cpu_tb.ddc
write_file -f vhdl cpu_tb -output ./VHDL/cpu_tb_SYNTH.vhd
quit
