...
network pc_counter (terminal pc_in_7_0_7, pc_in_7_0_6, pc_in_7_0_5, 
                             ...
                             pc_clk, pc_out_7_0_7, pc_out_7_0_6, pc_out_7_0_5, 
                             ...
                             pc_out_7_0_1, pc_out_7_0_0, vss, vdd)
{
   ...
   {count_reg_0_inst} dfa11 (n34, pc_clk, pc_rst, pc_out_0_port, vss, vdd);
   {count_reg_1_inst} dfa11 (n33, pc_clk, pc_rst, pc_out_1_port, vss, vdd);
   {count_reg_2_inst} dfa11 (n32, pc_clk, pc_rst, pc_out_2_port, vss, vdd);
   {count_reg_3_inst} dfa11 (n31, pc_clk, pc_rst, pc_out_3_port, vss, vdd);
   {count_reg_4_inst} dfa11 (n30, pc_clk, pc_rst, pc_out_4_port, vss, vdd);
   {count_reg_5_inst} dfa11 (n29, pc_clk, pc_rst, pc_out_5_port, vss, vdd);
   {count_reg_6_inst} dfa11 (n28, pc_clk, pc_rst, pc_out_6_port, vss, vdd);
   {count_reg_7_inst} dfa11 (n27, pc_clk, pc_rst, pc_out_7_port, vss, vdd);
