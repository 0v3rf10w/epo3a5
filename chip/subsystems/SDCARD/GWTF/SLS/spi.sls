                      ...
                      sclk, mosi, miso, ss, vss, vdd)
{
   ...
   {shft1} shift_reg (clk, reset, shift, shift_in, write_enable, 
                      write_in_7_0_7, write_in_7_0_6, write_in_7_0_5, 
                      write_in_7_0_4, write_in_7_0_3, write_in_7_0_2, 
                      write_in_7_0_1, write_in_7_0_0, read_out_7_port, 
                      read_out_6_port, read_out_5_port, read_out_4_port, 
                      read_out_3_port, read_out_2_port, read_out_1_port, 
                      read_out_0_port, vss, vdd);
   {ctrl1} control (clk, reset, send, count_3_port, count_2_port, count_1_port, 
                    count_0_port, shift, sclk_port, count_reset, ss, busy, vss, 
                    vdd);
   {shift_in_reg} dfa11 (miso, sclk_port, reset, shift_in, vss, vdd);
}
