...
BEGIN
  ...
  ctrl1_U26: mu111 PORT MAP (reset, send, N_45, N_40);
  cnt1_U10: iv110 PORT MAP (count_0_port, N_35);
  cnt1_U15: iv110 PORT MAP (count_2_port, N_44);
  ctrl1_U22: iv110 PORT MAP (N_37, N_38);
  ctrl1_U32: iv110 PORT MAP (N_46, N_39);
  ctrl1_U27: iv110 PORT MAP (shift, count_reset);
  ctrl1_U35: iv110 PORT MAP (count_0_port, N_49);
  cnt1_U13: ex210 PORT MAP (N_44, N_42, N_55);
  cnt1_U16: ex210 PORT MAP (count_1_port, count_0_port, N_36);
  cnt1_U11: ex210 PORT MAP (count_3_port, N_54, N_53);
  ...
  cnt1_U14: na210 PORT MAP (count_1_port, count_0_port, N_42);
  ctrl1_U28: na210 PORT MAP (N_47, N_43, N_48);
  ctrl1_U30: na210 PORT MAP (N_50, shift, N_47);
  ...
  ctrl1_U29: na310 PORT MAP (send, N_39, N_45, N_43);
  ctrl1_U33: na310 PORT MAP (count_3_port, N_49, N_51, N_50);
  ...
  cnt1_count_reg_0_inst: dfa11 PORT MAP (N_35, count_reset, sclk_int, count_0_port);
  cnt1_count_reg_1_inst: dfa11 PORT MAP (N_36, count_reset, sclk_int, count_1_port);
  cnt1_count_reg_3_inst: dfa11 PORT MAP (N_53, count_reset, sclk_int, count_3_port);
  cnt1_count_reg_2_inst: dfa11 PORT MAP (N_55, count_reset, sclk_int, count_2_port);
  ctrl1_state_reg_1_inst: dfa11 PORT MAP (N_48, reset, clk, N_46);
  ctrl1_state_reg_0_inst: dfa11 PORT MAP (N_38, reset, clk, N_45);
  shft1_U69: no210 PORT MAP (shift, write_enable, N_27);
  shft1_U67: no210 PORT MAP (N_27, write_enable, N_31);
  cnt1_U12: no210 PORT MAP (N_42, N_44, N_54);
  ctrl1_U23: no210 PORT MAP (N_41, N_52, N_37);
  ctrl1_U31: no210 PORT MAP (N_39, N_45, shift);
  ctrl1_U21: no210 PORT MAP (clk, count_reset, sclk_int);
  ctrl1_U25: no210 PORT MAP (N_46, N_40, N_41);
  ctrl1_U24: no210 PORT MAP (count_reset, N_50, N_52);
  ctrl1_U34: no210 PORT MAP (count_2_port, count_1_port, N_51);
